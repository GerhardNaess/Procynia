...
return new class extends Migration
{
    ...
    {
        Schema::create('enterprise_wiki_page_link_qa_attempts', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(
                ['enterprise_wiki_ingest_run_id', 'enterprise_wiki_page_id'],
                'ewplqa_run_page_unique',
            );
        });
    }
    ...
    {
        Schema::dropIfExists('enterprise_wiki_page_link_qa_attempts');
    }
};
