...
class WikiPageContentAiClient
{
    ...
    private function developerPrompt(string $pageType, string $languageName): string
    {
        ...
        $blockRules = implode("\n", [
            ...
            '- Step 4 — contribute where it adds value: when established good practice for this subject would add substantial value beyond what the source states, write a concrete best_practice block for it. Say plainly what Procynia recommends, and briefly why it is relevant for what this page describes.',
