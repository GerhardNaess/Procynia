...
class RequirementWikiAnswerAiClient
{
    ...
    private function developerPrompt(string $languageName): string
    {
        return implode("\n", [
            ...
            '- Use exactly three answer_sections in this order: one overview section about the vendor\'s ITIL system, one Incident Management section, and one Problem Management section.',
            '- Do not create a fourth summary, conclusion, or interplay section.',
            '- Do not add a separate ending section for process interfaces or cross-process coordination; fold any necessary handoffs, data flow, and decision points into the relevant Incident Management or Problem Management section.',
            '- The answer should end after the Problem Management section.',
            ...
            '- Use the sections with clear division of purpose: the overview should focus on framework and governance; incident-related sections should focus on incident handling; problem-related sections should focus on root-cause analysis and permanent actions.',
