...
class DocumentTextExtractor
{
    ...
    /**
     * Purpose: Resolve an image's alt-text via Word's own descr -> title -> name fallback chain.
     * Inputs: The <a:blip> element and the bound DOMXPath.
     * Returns: The first non-blank of wp:docPr's descr/title/name attributes, or null.
     * Side effects: None.
     */
    private function docxImageAltText(DOMElement $blipNode, DOMXPath $xpath): ?string
    {
        ...
        foreach (['descr', 'title', 'name'] as $attribute) {
