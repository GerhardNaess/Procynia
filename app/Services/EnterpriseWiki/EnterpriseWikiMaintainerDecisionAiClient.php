...
class EnterpriseWikiMaintainerDecisionAiClient
{
    ...
    public static function figurePlanningRules(): string
    {
        return implode("\n", [
            ...
            '  Choose exactly ONE primary page for each figure — the single concept_pages or',
            '  entity_pages entry that explains it in the most depth. That page is the figure\'s',
            '  scholarly home; never plan the same figure onto more than one concept/entity page.',
            '  In addition to that one primary page, source_article (and, if it also uses the',
            '  figure, source_summary) may show the SAME figure as a secondary presentation — this',
            '  is expected and normal, not a duplicate: the main article and its summary are allowed',
            '  to reuse a figure that a concept/entity page explains in full. A figure with no',
            '  concept/entity page at all may still be planned directly onto source_article and/or',
            '  source_summary alone. Never plan a figure onto source_summary without also planning',
            '  it onto source_article — the summary may only show a figure the article also shows.',
            '  Never plan the same figure onto two different concept pages, two different entity',
            '  pages, or one of each — out of ambiguity or otherwise.',
