...
class EnterpriseWikiMaintainerDecisionAiClient
{
    ...
    public static function patchTargetRules(): array
    {
        return [
            ...
            '  Copy ONLY the substance this document actually supersedes — not the sentences around it.',
            '  The server keeps the surrounding text exactly as it stands and records it as still',
            '  belonging to its original source; you must never retype neighbouring text to preserve it,',
            '  and replacement_substance must contain nothing this document does not itself support.',
            '  Make sure the text you copy occurs exactly once in the section you are targeting.',
