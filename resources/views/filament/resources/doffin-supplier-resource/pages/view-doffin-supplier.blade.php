    ...
    <div class="mx-auto max-w-6xl space-y-4">
        <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="grid gap-x-6 gap-y-4 px-5 py-4 md:grid-cols-2">
                <div class="space-y-1">
                    <div class="text-base font-semibold uppercase tracking-[0.12em] text-slate-600">Supplier name</div>
                ...
                <div class="space-y-1">
                    <div class="text-base font-semibold uppercase tracking-[0.12em] text-slate-600">Organization number</div>
                ...
                <div class="space-y-1">
                    <div class="text-base font-semibold uppercase tracking-[0.12em] text-slate-600">Normalized name</div>
                    <div class="text-base font-medium text-slate-900 break-all">
                        {{ $supplier->normalized_name }}
                    </div>
                </div>

                <div class="space-y-1">
                    <div class="text-base font-semibold uppercase tracking-[0.12em] text-slate-600">Updated at</div>
                    <div class="text-base font-medium text-slate-900">
        ...
        <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="flex items-center justify-between border-b border-slate-200 px-5 py-3">
                ...
                <span class="text-base leading-6 text-slate-600">{{ number_format(count($noticeRows)) }}</span>
            </div>

            <div class="max-h-[30rem] overflow-y-auto">
                @if (count($noticeRows) === 0)
                    <div class="px-5 py-6 text-base leading-6 text-slate-600">
                        ...
                        @foreach ($noticeRows as $notice)
                            <article class="px-5 py-3">
                                        ...
                                        <div class="flex flex-wrap items-center gap-2">
                                            @if ($notice['notice_record_id'])
                                                <a
                                                    ...
                                                    class="text-base font-semibold text-primary-600 hover:text-primary-500"
                                                >
                                            ...
                                            @if ($notice['source'])
                                                <span class="inline-flex items-center rounded-full bg-slate-100 px-2 py-1 text-base font-medium leading-6 text-slate-700 ring-1 ring-inset ring-slate-200">
                                                    {{ $notice['source'] }}
                                                </span>
                                            @endif
                                        </div>

                                        <div class="text-base font-medium leading-6 text-slate-950">
                                ...
                                <div class="mt-3 grid gap-x-4 gap-y-2 md:grid-cols-2 xl:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
                                    <div class="space-y-1">
                                        <div class="text-base font-semibold uppercase tracking-[0.12em] text-slate-600">Buyer</div>
                                    ...
                                    <div class="space-y-1">
                                        <div class="text-base font-semibold uppercase tracking-[0.12em] text-slate-600">Winner lots</div>
                                        <div class="text-base text-slate-900">
